...
* catra.conf: contains configuration settings for catrad or catra-qt
* catrad.pid: stores the process id of catrad while running
...
* debug.log: contains debug information and general logging generated by catrad or catra-qt
