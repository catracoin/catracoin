...
This document provides guidelines for internationalization of the Catra Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `catra_en.ts` remains unchanged.
