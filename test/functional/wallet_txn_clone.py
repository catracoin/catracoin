...
class TxnMallTest(CatraTestFramework):
    ...
    def run_test(self):
        ...
        # 40 CTA serialized is 00286bee00000000
        pos0 = 2 * (4 + 1 + 36 + 1 + 4 + 1)
        ...
        # Check node0's total balance; should be same as before the clone, + 100 CTA for 2 matured,
