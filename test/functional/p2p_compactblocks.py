...
# TestP2PConn: A peer we use to send messages to catrad, and store responses.
...
class CompactBlocksTest(CatraTestFramework):
    ...
    # This test actually causes catrad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that catrad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for catrad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # catrad will not send blocktxn responses for blocks whose height is
