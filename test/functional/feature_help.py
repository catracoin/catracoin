...
"""Verify that starting catra with -h works as expected."""

from test_framework.test_framework import CatraTestFramework
from test_framework.util import assert_equal

class HelpTest(CatraTestFramework):
    ...
    def run_test(self):
        self.log.info("Start catra with -h for help text")
        ...
        self.log.info("Start catra with -version for version information")
        ...
        self.log.info("Start catrad with -fakearg to make sure it does not start")
