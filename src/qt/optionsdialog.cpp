    ...
    mapper(0)
{
    ...
    ui->catraAtStartup->setToolTip(ui->catraAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->catraAtStartup->setText(ui->catraAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openCatraConfButton->setToolTip(ui->openCatraConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new CatraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->catraAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCatraConfButton_clicked()
{
