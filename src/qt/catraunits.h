...
#ifndef CATRA_QT_CATRAUNITS_H
#define CATRA_QT_CATRAUNITS_H
...
/** Catra unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CatraUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CatraUnits(QObject *parent);

    /** Catra units.
      @note Source: https://en.catra.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CTA,
...
typedef CatraUnits::Unit CatraUnit;

#endif // CATRA_QT_CATRAUNITS_H
