...
#ifndef CATRA_TEST_SCRIPTNUM10_H
#define CATRA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Catra Core 0.10.0, for cross-comparison.
 */
public:
