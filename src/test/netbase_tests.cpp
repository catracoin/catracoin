...
{
    BOOST_CHECK(TestSplitHost("www.catracore.org", "www.catracore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.catracore.org]", "www.catracore.org", -1));
    BOOST_CHECK(TestSplitHost("www.catracore.org:80", "www.catracore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.catracore.org]:80", "www.catracore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:27102", "127.0.0.1", 27102));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:27102", "127.0.0.1", 27102));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:27102", "::ffff:127.0.0.1", 27102));
    BOOST_CHECK(TestSplitHost("[::]:27102", "::", 27102));
    BOOST_CHECK(TestSplitHost("::27102", "::27102", -1));
    BOOST_CHECK(TestSplitHost(":27102", "", 27102));
    BOOST_CHECK(TestSplitHost("[]:27102", "", 27102));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:27102", "127.0.0.1:27102"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:27102", "[::]:27102"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
