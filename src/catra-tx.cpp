...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " catra-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  catra-tx [options] <hex-tx> [commands]  Update hex-encoded catra transaction\n" +
            "or:     catra-tx [options] -create [commands]   Create hex-encoded catra transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded catra transaction
